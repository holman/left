This is the personal site of Yoav Zimmerman. It is built off of the Left theme for jekyll designed by [zachholman.com](http://zachholman.com/) and hosted on github pages.
